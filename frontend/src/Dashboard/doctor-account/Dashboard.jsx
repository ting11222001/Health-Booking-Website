...
const Dashboard = () => {
  ...
  // and use the global state of auth for the data display
            ...
            <div className="grid lg:grid-cols-3 gap-[30px] lg:gap-[50px]">
              ...
              <div className="lg:col-span-2">
                ...
                <div className="mt-8">
                    ...
                    <div>
                      <div className="flex items-center gap-4 mb-10">
                        <figure className="max-w-[200px] max-h-[200px]">
                          <img src={user?.photo} alt="" className="w-full rounded-lg" />
                        </figure>
                  ...
                  {tab === 'settings' &&
                    <div>
                      <Profile doctorData={user} />
                    </div>}

                  {tab === 'create-blog' &&
                    <div>
                      <CreateBlog doctorData={user} />
                    </div>
                  }

                  {tab === 'list-blog' &&
                    <div>
                      <ListBlog doctorData={user} />
                    </div>
                  }
                </div>
              </div>
